...
the sketch went. The review also noted the README shows the name twice, in
the banner and in the heading beneath it; the heading is kept, because it is
the document's title and the banner is a picture.
